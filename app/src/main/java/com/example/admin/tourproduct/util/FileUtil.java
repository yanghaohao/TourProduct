...
public class FileUtil {
    ...
    //        addFileType("BMP", FILE_TYPE_BMP, "image/x-ms-bmp");
    //        addFileType("WBMP", FILE_TYPE_WBMP, "image/vnd.wap.wbmp");
    public static Type fileType(String flieName){
        List<Type> list  = new ArrayList<>();
        list.add(new Type("jpg","image/jpeg"));
        list.add(new Type("JPG","image/jpeg"));
        list.add(new Type("jpeg","image/jpeg"));
        list.add(new Type("JPEG","image/jpeg"));
        list.add(new Type("gif","image/gif"));
        list.add(new Type("GIF","image/gif"));
        list.add(new Type("png","image/png"));
        list.add(new Type("PNG","image/png"));
        list.add(new Type("bmp","image/x-ms-bmp"));
        list.add(new Type("BMP","image/x-ms-bmp"));
        list.add(new Type("wbmp","image/vnd.wap.wbmp"));
        list.add(new Type("WBMP","image/vnd.wap.wbmp"));
        Type type = null;
        for (int i = 0;i <list.size();i++){
            if (flieName.endsWith(list.get(i).getType())){
                type = list.get(i);
            }
        }
        return type;
