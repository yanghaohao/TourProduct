package com.example.admin.tourproduct.manager;
...
//            if (debug) {
//                LogUtil.v("LocalBroadcastManager", "Resolving type " + type + " scheme " + scheme + " of intent " + intent);
//            }
//
//            ArrayList entries = (ArrayList) this.mActions.get(intent.getAction());
//            if (entries != null) {
//                if (debug) {
//                    LogUtil.v("LocalBroadcastManager", "Action list: " + entries);
//                }
//
...
//                    if (debug) {
//                        LogUtil.v("LocalBroadcastManager", "Matching against filter " + receiver.filter);
//                    }
//
//                    if (receiver.broadcasting) {
//                        if (debug) {
//                            LogUtil.v("LocalBroadcastManager", "  Filter\'s target already added");
//                        }
//                    } else {
//                        int match = receiver.filter.match(action, type, scheme, data, categories, "LocalBroadcastManager");
//                        if (match >= 0) {
//                            if (debug) {
//                                LogUtil.v("LocalBroadcastManager", "  Filter matched!  match=0x" + Integer.toHexString(match));
//                            }
//
//                            if (receivers == null) {
...
//                            }
//
//                            LogUtil.v("LocalBroadcastManager", "  Filter did not match: " + reason);
//                        }
//                    }
//                }
//
